...
class BottomNavBar @JvmOverloads constructor(
    ...
    init {
        ...
        val msgItem = BottomNavigationItem(R.drawable.btn_nav_msg_press, resources.getString(R.string.nav_bar_msg))
                ...
                .setActiveColorResource(R.color.common_blue)
                .setInActiveColorResource(R.color.text_normal)
        mMsgBadge = ShapeBadgeItem().setShape(ShapeBadgeItem.SHAPE_OVAL)
        ...
        addItem(homeItem).addItem(categoryItem).addItem(cartItem).addItem(msgItem).addItem(userItem).initialise()
    }
